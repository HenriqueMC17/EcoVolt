...
- Name: conversion.spec.ts >> Landing Page >> should render the hero section with the main CTA
- Location: e2e\conversion.spec.ts:25:7
...
Locator: getByRole('link', { name: /começar|solicitar|agendar|demo|acesso/i }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /começar|solicitar|agendar|demo|acesso/i }).first()
