...
- Location: e2e\conversion.spec.ts:10:7
...
Locator: getByRole('link', { name: /começar|solicitar|agendar/i }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /começar|solicitar|agendar/i }).first()
