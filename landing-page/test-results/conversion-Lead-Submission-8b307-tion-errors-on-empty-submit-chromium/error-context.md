...
- Name: conversion.spec.ts >> Lead Submission Form — Conversion Path >> should show validation errors on empty submit
- Location: e2e\conversion.spec.ts:89:7
...
Locator: getByRole('button', { name: /solicitar contato/i })
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /solicitar contato/i })
