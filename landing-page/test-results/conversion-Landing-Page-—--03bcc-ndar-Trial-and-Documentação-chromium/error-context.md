...
- Name: conversion.spec.ts >> Landing Page — Hero & Navigation >> should render hero CTA buttons — Agendar Trial and Documentação
- Location: e2e\conversion.spec.ts:34:7
